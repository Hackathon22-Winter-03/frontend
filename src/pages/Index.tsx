...
計算モデルというのは Wikipedia を参照すると「計算・推論・証明といった行為を理論的・抽象的に考察するための数理モデルである。」と書いてありますが、
よくわからないのでざっくり説明すると文字列の読み書き, 置換や移動などといった操作だけで動く機械と思えばいいです。
それを使って色んな問題を解いてみようというのがこのサイトの趣旨です。

問題で使われる計算モデルには様々な種類があり、拡張マルコフアルゴリズムやTag-System、
チューリングマシン、SKIコンビネータなどがあり、それぞれの問題で提供されます。
